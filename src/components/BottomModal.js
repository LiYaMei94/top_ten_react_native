...
export default class bottom_modal extends React.Component {
    static propTypes={
        picker_item_text:PropTypes.array,
        optionStyle:PropTypes.object,
        isVisible:PropTypes.bool,
        closeBottomPicker:PropTypes.func,
                                ...
                                return (
                                    <TouchableHighlight
                                        ...
                                        style={[styles.picker_item, {
                                            borderBottomColor: index != picker_item_text.length - 1 ? '#EFEFF1' : 'transparent', borderBottomWidth: index != picker_item_text.length - 1 ? 1 : 0,
